---
layout: doc
title: 我们在母婴护理服务过程中碰到的经典案例
description: 不仅仅包括安抚婴儿哭声，还包括母乳喂养、黄疸、尿布疹、婴儿被动操、宝宝飞机抱、胎教、宝宝大动作精细动作发展等等
---

# <span style="font-size: 14px; color: var(--vp-c-brand); margin-top: 9px;">写在前面</span>

我们会把用户使用的反馈、咨询我们的专业问题、在家政服务过程中碰到的新鲜事等等，不定时发布于此。

## <span style="font-size: 14px; color: var(--vp-c-brand); margin-top: 9px;">老婆发现，我手机收藏6000多…</span>
...
## <span style="font-size: 14px; color: var(--vp-c-brand); margin-top: 9px;">文章2</span>

（待发布）

## <span style="font-size: 14px; color: var(--vp-c-brand); margin-top: 9px;">文章3</span>

（待发布）

## <span style="font-size: 14px; color: var(--vp-c-brand); margin-top: 9px;">文章4</span>

（待发布）

## <span style="font-size: 14px; color: var(--vp-c-brand); margin-top: 9px;">文章5</span>
